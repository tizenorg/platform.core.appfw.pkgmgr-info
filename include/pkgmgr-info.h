...
/**
 * @fn int pkgmgrinfo_appinfo_get_mount_point(pkgmgrinfo_appinfo_h handle, char **mount_point)
 * @brief	This API gets mount point of package file name associated with the package which contain given application
 *
 * @par	This API is for package-manager client application
 * @par Sync (or) Async : Synchronous API
 *
 * @param[in] handle 		pointer to the appinfo handle.
 * @param[out] tep_name 	pointer to hold mount point path or empty if package is not "mount-installed"
 * @return	0 if success, error code(<0) if fail
 * @retval	PMINFO_R_OK success
 * @retval	PMINFO_R_EINVAL invalid argument
 * @retval	PMINFO_R_ERROR  internal error
 ...
 * @see	pkgmgrinfo_appinfo_get_appid()
 * @code
static int get_mount_point_path(const char *appid)
{
	int ret = 0;
	char *mount_point = NULL;
	pkgmgrinfo_appinfo_h handle = NULL;
 ...
 * @endcode
 */
int pkgmgrinfo_appinfo_get_mount_point(pkgmgrinfo_appinfo_h handle, char **mount_point);

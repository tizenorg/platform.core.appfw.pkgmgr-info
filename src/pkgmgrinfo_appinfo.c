		...
		pkgmgr_appinfo_x **appinfo, bool is_disabled)
{
	...
	ret = _appinfo_get_filtered_list(uid, filter, locale,
		...
		pkgmgrinfo_app_list_cb app_func, void *user_data, uid_t uid)
{
	...
	ret = _appinfo_get_filtered_foreach_appinfo(uid, filter, PMINFO_APPINFO_GET_ALL, app_func,
			user_data);
		...
		void *user_data)
{
	...
	if (pkgmgrinfo_appinfo_filter_add_bool(filter, PMINFO_APPINFO_PROP_APP_DISABLE, false)) {
		pkgmgrinfo_appinfo_filter_destroy(filter);
		return PMINFO_R_ERROR;
	}
...
{
	return pkgmgrinfo_appinfo_get_usr_installed_list_full(app_func, uid,
			PMINFO_APPINFO_GET_ALL, user_data);
}

API int pkgmgrinfo_appinfo_get_install_list(pkgmgrinfo_app_list_cb app_func,
		void *user_data)
{
	return pkgmgrinfo_appinfo_get_usr_install_list_full(app_func,
			GLOBAL_USER, PMINFO_APPINFO_GET_ALL, user_data);
}
...
API int pkgmgrinfo_appinfo_get_usr_installed_list(pkgmgrinfo_app_list_cb app_func, uid_t uid, void *user_data)
{
	...
	return _appinfo_get_filtered_foreach_appinfo(uid, NULL, PMINFO_APPINFO_GET_ALL, app_func,
			user_data);
}

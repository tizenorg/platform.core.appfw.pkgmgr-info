...
static int __insert_application_info(manifest_x *mfx)
{
	...
	for (tmp = mfx->application; tmp; tmp = tmp->next) {
		...
		snprintf(query, MAX_QUERY_LEN,
			...
			"app_tep_name, app_mount_point, app_background_category, app_package_type, app_root_path, app_api_version, " \
			...
			__get_str(mfx->tep_name), mfx->mount_point, background_value, type, mfx->root_path, __get_str(mfx->api_version),
...
static int __insert_manifest_info_in_db(manifest_x *mfx, uid_t uid)
{
	...
	snprintf(query, MAX_QUERY_LEN,
		...
		"package, package_type, package_version, package_api_version, package_tep_name, package_mount_point, " \
		...
		"'%s', '%s', '%s', '%s', '%s', " \
		"'%s')", \
		mfx->package, mfx->type, mfx->version, __get_str(mfx->api_version), __get_str(mfx->tep_name), mfx->mount_point,

...
static void __find_portrait_operation_splashscreen_with_dpi(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
	int dpi = -1;
...
static void __find_portrait_operation_splashscreen(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
...
static void __find_landscape_operation_splashscreen_with_dpi(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
	int dpi = -1;
...
static void __find_landscape_operation_splashscreen(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
	splashscreen_x *ss_tmp;
...
static GList *__find_splashscreens(GList *splashscreens)
{
	...
	g_list_foreach(splashscreens,
			__find_portrait_operation_splashscreen_with_dpi, &portrait_list);
	g_list_foreach(splashscreens,
			__find_portrait_operation_splashscreen, &portrait_list);
	ss = __find_default_splashscreen(splashscreens, "portrait");
	if (ss)
		portrait_list = g_list_append(portrait_list, ss);

	g_list_foreach(splashscreens,
			__find_landscape_operation_splashscreen_with_dpi, &landscape_list);
	g_list_foreach(splashscreens,
			__find_landscape_operation_splashscreen, &landscape_list);

...
static void __find_appcontrol_portrait_splashscreen_with_dpi(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
	int dpi = -1;
...
static void __find_appcontrol_portrait_splashscreen(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
...
static void __find_appcontrol_landscape_splashscreen_with_dpi(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
	int dpi = -1;
...
static void __find_appcontrol_landscape_splashscreen(gpointer a, gpointer b)
{
	splashscreen_x *ss = (splashscreen_x *)a;
	GList **list = (GList **)b;
	splashscreen_x *ss_tmp;
